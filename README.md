...
- Have functions be installable like how `winloop` and `uvloop` work where the original random module can still be utilized but where the api calls are replaced with faster ones while newer added api calls can be called from this library
